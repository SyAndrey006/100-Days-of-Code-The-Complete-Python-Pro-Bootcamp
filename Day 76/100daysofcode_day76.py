# -*- coding: utf-8 -*-
"""100DaysOfCode_Day76.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1eJq1r7StzspDvqEvQd2_itdvt_PG6RvV
"""
...
df_apps_clean = df_apps_clean.sort_values('Reviews', ascending=False).drop_duplicates(subset=['App'], keep='first')
...
fig = px.pie(ratings, values=ratings.values, names=ratings.index)
fig.show()
