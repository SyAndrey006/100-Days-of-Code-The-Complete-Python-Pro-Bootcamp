# -*- coding: utf-8 -*-
"""100DaysOfCode_Day80.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/15YX_k2GZu5qKsQY8QdLG36V7woBySwKQ
...
aw_line, = plt.plot(after_washing.date, after_washing.pct_deaths, 'skyblue', linewidth=3, marker='o', label='After Handwashing')
...
hist = px.histogram(df_monthly, x='pct_deaths', color='washing_hands', nbins=30, opacity=0.6, barmode='overlay', histnorm='percent', marginal='box',)
